...
const fileValid = computed(() => uploadForm.value?.file?.type === "video/mp4");
const canSubmit = computed(
  () => titleValid.value && descriptionValid.value && fileValid.value,
);
    ...
    <form @submit.prevent="submitUpload" class="space-y-6">
      ...
      <div>
        ...
        <input v-model="uploadForm.title" type="text" required maxlength="100" :placeholder="t('profile.titlePlaceholder')"
          :class="[
            'form-input flex-1 bg-gray-50 dark:bg-gray-900 border rounded-lg px-3 py-2 focus:ring-2 w-full transition',
      ...
      <div>
        ...
        <textarea v-model="uploadForm.description" rows="3" maxlength="500" :placeholder="t('profile.descriptionPlaceholder')"
          :class="[
            'form-textarea flex-1 bg-gray-50 dark:bg-gray-900 border rounded-lg px-3 py-2 focus:ring-2 w-full transition',
